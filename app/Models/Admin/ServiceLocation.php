...
class ServiceLocation extends Model
{
    ...
    protected $fillable = ['name','currency_name','currency_code','currency_symbol','country','timezone','active','company_key','seat_status'];
    ...
    */
    ...
    {
      return $this->hasMany(Zone::class, 'service_location_id', 'id')->orderBy('position','asc');
