  ...
  public function updateVehicleType(Request $request)
    {
        ...
        $currentVehicleType = $driver->vehicle_type;
        
// dd( $currentVehicleType);
        if($driver->base_vehicle_type == ""){
            $driver->base_vehicle_type = $currentVehicleType;
        }
        $newVehicleType = '';

        if ($currentVehicleType === 'e9e3cf60-6b6f-4d59-b551-b23c00dcdbf9') {
            $newVehicleType = 'cd3b5670-73d8-4965-a5ca-39952ed51245';
        }elseif($currentVehicleType === 'cd3b5670-73d8-4965-a5ca-39952ed51245' && $driver->base_vehicle_type === 'e9e3cf60-6b6f-4d59-b551-b23c00dcdbf9'){
            $newVehicleType = 'e9e3cf60-6b6f-4d59-b551-b23c00dcdbf9';
        }
         elseif ($currentVehicleType === 'cd3b5670-73d8-4965-a5ca-39952ed51245') {
            $newVehicleType = '8f9f6476-7acb-456f-b8ea-b6e66c2afeff';
        } elseif ($currentVehicleType === '8f9f6476-7acb-456f-b8ea-b6e66c2afeff' && $driver->base_vehicle_type === 'cd3b5670-73d8-4965-a5ca-39952ed51245') {
            $newVehicleType = 'cd3b5670-73d8-4965-a5ca-39952ed51245';
        } // Add more conditions as needed

        // Check if a valid transition occurred
        if ($newVehicleType === '') {
            return response()->json(['error' => 'Invalid vehicle type transition'], 400);
        }

        // Update the driver's vehicle type
        $driver->vehicle_type = $newVehicleType;
        $driver->save();

        return response()->json(['message' => "Driver's vehicle type updated to $newVehicleType"]);
    }
