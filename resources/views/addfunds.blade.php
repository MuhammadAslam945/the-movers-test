...
.stark-login input[type="radio"]:checked + label {
  background: #0C6125;
  background: linear-gradient(#393939, #292929);
  color: #00fffc;
  box-shadow: 0 0 5px rgba(0, 255, 253, 0.2), inset 0 0 5px rgba(0, 255, 253, 0.1), 0 2px 0 #000;
...
@csrf
    ...
    <input type="radio" name="order_amount" id="amount-500" value="500" required>
    <label for="amount-500">$500</label>

    <input type="radio" name="order_amount" id="amount-1000" value="1000" required>
