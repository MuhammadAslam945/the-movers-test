...
<div class="col-sm-6">
        <div class="form-group">
            ...
            <select class="form-control" id="seat_status" name="seat_status">
                <option value="active" {{ old('seat_status', $item->seat_status) === 'active' ? 'selected' : '' }}>@lang('view_pages.active')</option>
                <option value="inactive" {{ old('seat_status', $item->seat_status) === 'inactive' ? 'selected' : '' }}>@lang('view_pages.inactive')</option>
            </select>
